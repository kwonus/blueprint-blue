...
#ifndef FLATBUFFERS_GENERATED_BLUEPRINTREPLY_XBLUEPRINT_H_
#define FLATBUFFERS_GENERATED_BLUEPRINTREPLY_XBLUEPRINT_H_
...
struct XResults FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XFind>> *results() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XFind>> *>(VT_RESULTS);
  }
...
struct XResultsBuilder {
  ...
  void add_results(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XFind>>> results) {
...
inline flatbuffers::Offset<XResults> CreateXResults(
    ...
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XFind>>> results = 0,
    uint32_t scope = 0) {
...
inline flatbuffers::Offset<XResults> CreateXResultsDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<flatbuffers::Offset<XBlueprint::XFind>> *results = nullptr,
    uint32_t scope = 0) {
  auto results__ = results ? _fbb.CreateVector<flatbuffers::Offset<XBlueprint::XFind>>(*results) : 0;
  return XBlueprint::CreateXResults(
      _fbb,
      results__,
      scope);
}
...
struct XFind FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XFound>> *found() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XFound>> *>(VT_FOUND);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct XFindBuilder {
  ...
  void add_found(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XFound>>> found) {
...
inline flatbuffers::Offset<XFind> CreateXFind(
    ...
    bool negate = false,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XFound>>> found = 0) {
...
inline flatbuffers::Offset<XFind> CreateXFindDirect(
    ...
    bool negate = false,
    const std::vector<flatbuffers::Offset<XBlueprint::XFound>> *found = nullptr) {
  auto find__ = find ? _fbb.CreateString(find) : 0;
  auto found__ = found ? _fbb.CreateVector<flatbuffers::Offset<XBlueprint::XFound>>(*found) : 0;
  return XBlueprint::CreateXFind(
      _fbb,
      find__,
      negate,
      found__);
...
struct XFound FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XMatch>> *matches() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XMatch>> *>(VT_MATCHES);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct XFoundBuilder {
  ...
  void add_matches(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XMatch>>> matches) {
...
inline flatbuffers::Offset<XFound> CreateXFound(
    ...
    uint32_t start = 0,
    uint32_t until = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XMatch>>> matches = 0) {
...
inline flatbuffers::Offset<XFound> CreateXFoundDirect(
    ...
    uint32_t start = 0,
    uint32_t until = 0,
    const std::vector<flatbuffers::Offset<XBlueprint::XMatch>> *matches = nullptr) {
  auto matches__ = matches ? _fbb.CreateVector<flatbuffers::Offset<XBlueprint::XMatch>>(*matches) : 0;
  return XBlueprint::CreateXFound(
      _fbb,
      start,
      until,
      matches__);
...
inline flatbuffers::Offset<XMatch> CreateXMatchDirect(
  ...
  return XBlueprint::CreateXMatch(
      _fbb,
      fragment__,
      feature__,
      coordinates);
...
inline const XBlueprint::XResults *GetXResults(const void *buf) {
  return flatbuffers::GetRoot<XBlueprint::XResults>(buf);
}

inline const XBlueprint::XResults *GetSizePrefixedXResults(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<XBlueprint::XResults>(buf);
}

inline bool VerifyXResultsBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<XBlueprint::XResults>(nullptr);
}

inline bool VerifySizePrefixedXResultsBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<XBlueprint::XResults>(nullptr);
}

inline void FinishXResultsBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<XBlueprint::XResults> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_BLUEPRINTREPLY_XBLUEPRINT_H_
