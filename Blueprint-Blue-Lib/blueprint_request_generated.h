...
#ifndef FLATBUFFERS_GENERATED_BLUEPRINTREQUEST_XBLUEPRINT_H_
#define FLATBUFFERS_GENERATED_BLUEPRINTREQUEST_XBLUEPRINT_H_
...
template<> struct XCompareTraits<XBlueprint::XWord> {
  static const XCompare enum_value = XCompare_text;
};

template<> struct XCompareTraits<XBlueprint::XLemma> {
  static const XCompare enum_value = XCompare_lemma;
};

template<> struct XCompareTraits<XBlueprint::XPOS16> {
  static const XCompare enum_value = XCompare_pos16;
};

template<> struct XCompareTraits<XBlueprint::XPOS32> {
  static const XCompare enum_value = XCompare_pos32;
};

template<> struct XCompareTraits<XBlueprint::XPunctuation> {
  static const XCompare enum_value = XCompare_punctuation;
};

template<> struct XCompareTraits<XBlueprint::XTransition> {
  static const XCompare enum_value = XCompare_transition;
};

template<> struct XCompareTraits<XBlueprint::XStrongs> {
  static const XCompare enum_value = XCompare_strongs;
};

template<> struct XCompareTraits<XBlueprint::XDelta> {
...
struct XRequest FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const XBlueprint::XSettings *settings() const {
    return GetPointer<const XBlueprint::XSettings *>(VT_SETTINGS);
  }
  const flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XSearch>> *search() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XSearch>> *>(VT_SEARCH);
  }
  const flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XScope>> *scope() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XScope>> *>(VT_SCOPE);
  }
...
struct XRequestBuilder {
  ...
  void add_settings(flatbuffers::Offset<XBlueprint::XSettings> settings) {
    fbb_.AddOffset(XRequest::VT_SETTINGS, settings);
  }
  void add_search(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XSearch>>> search) {
    fbb_.AddOffset(XRequest::VT_SEARCH, search);
  }
  void add_scope(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XScope>>> scope) {
...
inline flatbuffers::Offset<XRequest> CreateXRequest(
    ...
    flatbuffers::Offset<XBlueprint::XSettings> settings = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XSearch>>> search = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XScope>>> scope = 0) {
...
inline flatbuffers::Offset<XRequest> CreateXRequestDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<XBlueprint::XSettings> settings = 0,
    const std::vector<flatbuffers::Offset<XBlueprint::XSearch>> *search = nullptr,
    const std::vector<flatbuffers::Offset<XBlueprint::XScope>> *scope = nullptr) {
  auto search__ = search ? _fbb.CreateVector<flatbuffers::Offset<XBlueprint::XSearch>>(*search) : 0;
  auto scope__ = scope ? _fbb.CreateVector<flatbuffers::Offset<XBlueprint::XScope>>(*scope) : 0;
  return XBlueprint::CreateXRequest(
      _fbb,
      settings,
      search__,
      scope__);
...
struct XSearch FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XSegment>> *segments() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XSegment>> *>(VT_SEGMENTS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct XSearchBuilder {
  ...
  void add_segments(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XSegment>>> segments) {
...
inline flatbuffers::Offset<XSearch> CreateXSearch(
    ...
    bool negate = false,
    bool quoted = false,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XSegment>>> segments = 0) {
...
inline flatbuffers::Offset<XSearch> CreateXSearchDirect(
    ...
    bool negate = false,
    bool quoted = false,
    const std::vector<flatbuffers::Offset<XBlueprint::XSegment>> *segments = nullptr) {
  auto search__ = search ? _fbb.CreateString(search) : 0;
  auto segments__ = segments ? _fbb.CreateVector<flatbuffers::Offset<XBlueprint::XSegment>>(*segments) : 0;
  return XBlueprint::CreateXSearch(
      _fbb,
      search__,
      negate,
      quoted,
...
struct XSegment FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XFragment>> *fragments() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XFragment>> *>(VT_FRAGMENTS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct XSegmentBuilder {
  ...
  void add_fragments(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XFragment>>> fragments) {
...
inline flatbuffers::Offset<XSegment> CreateXSegment(
    ...
    bool anchored = false,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XFragment>>> fragments = 0) {
...
inline flatbuffers::Offset<XSegment> CreateXSegmentDirect(
    ...
    bool anchored = false,
    const std::vector<flatbuffers::Offset<XBlueprint::XFragment>> *fragments = nullptr) {
  auto segment__ = segment ? _fbb.CreateString(segment) : 0;
  auto fragments__ = fragments ? _fbb.CreateVector<flatbuffers::Offset<XBlueprint::XFragment>>(*fragments) : 0;
  return XBlueprint::CreateXSegment(
      _fbb,
      segment__,
      anchored,
      fragments__);
...
struct XFragment FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XFeature>> *features() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XFeature>> *>(VT_FEATURES);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct XFragmentBuilder {
  ...
  void add_features(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XFeature>>> features) {
...
inline flatbuffers::Offset<XFragment> CreateXFragment(
    ...
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<XBlueprint::XFeature>>> features = 0) {
...
inline flatbuffers::Offset<XFragment> CreateXFragmentDirect(
    ...
    const std::vector<flatbuffers::Offset<XBlueprint::XFeature>> *features = nullptr) {
  auto fragment__ = fragment ? _fbb.CreateString(fragment) : 0;
  auto features__ = features ? _fbb.CreateVector<flatbuffers::Offset<XBlueprint::XFeature>>(*features) : 0;
  return XBlueprint::CreateXFragment(
      _fbb,
      fragment__,
      features__);
}
...
struct XFeature FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  XBlueprint::XCompare match_type() const {
    return static_cast<XBlueprint::XCompare>(GetField<uint8_t>(VT_MATCH_TYPE, 0));
  }
  const void *match() const {
    return GetPointer<const void *>(VT_MATCH);
  }
  template<typename T> const T *match_as() const;
  const XBlueprint::XWord *match_as_text() const {
    return match_type() == XBlueprint::XCompare_text ? static_cast<const XBlueprint::XWord *>(match()) : nullptr;
  }
  const XBlueprint::XLemma *match_as_lemma() const {
    return match_type() == XBlueprint::XCompare_lemma ? static_cast<const XBlueprint::XLemma *>(match()) : nullptr;
  }
  const XBlueprint::XPOS16 *match_as_pos16() const {
    return match_type() == XBlueprint::XCompare_pos16 ? static_cast<const XBlueprint::XPOS16 *>(match()) : nullptr;
  }
  const XBlueprint::XPOS32 *match_as_pos32() const {
    return match_type() == XBlueprint::XCompare_pos32 ? static_cast<const XBlueprint::XPOS32 *>(match()) : nullptr;
  }
  const XBlueprint::XPunctuation *match_as_punctuation() const {
    return match_type() == XBlueprint::XCompare_punctuation ? static_cast<const XBlueprint::XPunctuation *>(match()) : nullptr;
  }
  const XBlueprint::XTransition *match_as_transition() const {
    return match_type() == XBlueprint::XCompare_transition ? static_cast<const XBlueprint::XTransition *>(match()) : nullptr;
  }
  const XBlueprint::XStrongs *match_as_strongs() const {
    return match_type() == XBlueprint::XCompare_strongs ? static_cast<const XBlueprint::XStrongs *>(match()) : nullptr;
  }
  const XBlueprint::XDelta *match_as_delta() const {
    return match_type() == XBlueprint::XCompare_delta ? static_cast<const XBlueprint::XDelta *>(match()) : nullptr;
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
template<> inline const XBlueprint::XWord *XFeature::match_as<XBlueprint::XWord>() const {
  return match_as_text();
}

template<> inline const XBlueprint::XLemma *XFeature::match_as<XBlueprint::XLemma>() const {
  return match_as_lemma();
}

template<> inline const XBlueprint::XPOS16 *XFeature::match_as<XBlueprint::XPOS16>() const {
  return match_as_pos16();
}

template<> inline const XBlueprint::XPOS32 *XFeature::match_as<XBlueprint::XPOS32>() const {
  return match_as_pos32();
}

template<> inline const XBlueprint::XPunctuation *XFeature::match_as<XBlueprint::XPunctuation>() const {
  return match_as_punctuation();
}

template<> inline const XBlueprint::XTransition *XFeature::match_as<XBlueprint::XTransition>() const {
  return match_as_transition();
}

template<> inline const XBlueprint::XStrongs *XFeature::match_as<XBlueprint::XStrongs>() const {
  return match_as_strongs();
}

template<> inline const XBlueprint::XDelta *XFeature::match_as<XBlueprint::XDelta>() const {
...
struct XFeatureBuilder {
  ...
  void add_match_type(XBlueprint::XCompare match_type) {
...
inline flatbuffers::Offset<XFeature> CreateXFeature(
    ...
    bool negate = false,
    XBlueprint::XCompare match_type = XBlueprint::XCompare_NONE,
...
inline flatbuffers::Offset<XFeature> CreateXFeatureDirect(
  ...
  return XBlueprint::CreateXFeature(
      _fbb,
      feature__,
      rule__,
      negate,
...
inline flatbuffers::Offset<XLemma> CreateXLemmaDirect(
  ...
  return XBlueprint::CreateXLemma(
      _fbb,
      lemmata__);
}
...
struct XStrongs FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  XBlueprint::XLangEnum lang() const {
    return static_cast<XBlueprint::XLangEnum>(GetField<int8_t>(VT_LANG, 0));
  }
...
struct XStrongsBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_lang(XBlueprint::XLangEnum lang) {
...
inline flatbuffers::Offset<XStrongs> CreateXStrongs(
    flatbuffers::FlatBufferBuilder &_fbb,
    XBlueprint::XLangEnum lang = XBlueprint::XLangEnum_X,
    uint16_t number = 0) {
...
struct XSettings FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  XBlueprint::XLexEnum lexicon() const {
    return static_cast<XBlueprint::XLexEnum>(GetField<int8_t>(VT_LEXICON, 0));
  }
  XBlueprint::XFmtEnum format() const {
    return static_cast<XBlueprint::XFmtEnum>(GetField<int8_t>(VT_FORMAT, 0));
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct XSettingsBuilder {
  ...
  void add_lexicon(XBlueprint::XLexEnum lexicon) {
    fbb_.AddElement<int8_t>(XSettings::VT_LEXICON, static_cast<int8_t>(lexicon), 0);
  }
  void add_format(XBlueprint::XFmtEnum format) {
...
inline flatbuffers::Offset<XSettings> CreateXSettings(
    ...
    bool exact = false,
    uint16_t span = 0,
    XBlueprint::XLexEnum lexicon = XBlueprint::XLexEnum_AV,
    XBlueprint::XFmtEnum format = XBlueprint::XFmtEnum_JSON) {
...
inline bool VerifyXCompare(flatbuffers::Verifier &verifier, const void *obj, XCompare type) {
  switch (type) {
    ...
    case XCompare_text: {
      auto ptr = reinterpret_cast<const XBlueprint::XWord *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case XCompare_lemma: {
      auto ptr = reinterpret_cast<const XBlueprint::XLemma *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case XCompare_pos16: {
      auto ptr = reinterpret_cast<const XBlueprint::XPOS16 *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case XCompare_pos32: {
      auto ptr = reinterpret_cast<const XBlueprint::XPOS32 *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case XCompare_punctuation: {
      auto ptr = reinterpret_cast<const XBlueprint::XPunctuation *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case XCompare_transition: {
      auto ptr = reinterpret_cast<const XBlueprint::XTransition *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case XCompare_strongs: {
      auto ptr = reinterpret_cast<const XBlueprint::XStrongs *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case XCompare_delta: {
      auto ptr = reinterpret_cast<const XBlueprint::XDelta *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }
...
inline const XBlueprint::XRequest *GetXRequest(const void *buf) {
  return flatbuffers::GetRoot<XBlueprint::XRequest>(buf);
}

inline const XBlueprint::XRequest *GetSizePrefixedXRequest(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<XBlueprint::XRequest>(buf);
}

inline bool VerifyXRequestBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<XBlueprint::XRequest>(nullptr);
}

inline bool VerifySizePrefixedXRequestBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<XBlueprint::XRequest>(nullptr);
}

inline void FinishXRequestBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<XBlueprint::XRequest> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_BLUEPRINTREQUEST_XBLUEPRINT_H_
