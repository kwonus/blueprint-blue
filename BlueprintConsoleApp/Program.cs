namespace BlueprintConsoleApp
{
    ...
    internal class Program
    {
        ...
        static string[] TestStmt = { "%exact = 1 || Extacto", "$Exacto", "-- spoke", @"%exact = default %exact::1 %format::json ""help ... time [of need]"" + please + help time of|for&/noun/ need + greetings < Genesis [1 2 10] => c:\filename" };
